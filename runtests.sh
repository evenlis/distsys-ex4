...
# echo 'Using rmic'
# Library/Java/JavaVirtualMachines/jdk1.7.0_51.jdk/Contents/Home/bin/rmic ServerImpl
# Library/Java/JavaVirtualMachines/jdk1.7.0_51.jdk/Contents/Home/bin/rmic RegistryProxyImpl
 
echo 'Starting RMI Registry'
#Uncomment the line which works on your OS/Window manager
# Library/Java/JavaVirtualMachines/jdk1.7.0_51.jdk/Contents/Home/bin/java StartRegistry $port &
